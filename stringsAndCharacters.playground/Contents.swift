...
course[course.startIndex..<course.index(course.endIndex, offsetBy: -21)]
course[course.index(course.startIndex, offsetBy: 6)..<course.endIndex]
course[course.startIndex..<course.index(course.endIndex,offsetBy: -14)]
